...
[
  ...
  AC_ARG_ENABLE(exodus_long_names,
                AS_HELP_STRING([--enable-exodus-long-names],
                               [build with ExodusII long name support]),
                [AS_CASE("${enableval}",
                         [yes],      [enableexoduslongnames=yes],
                         [no],       [enableexoduslongnames=no],
                         [AC_MSG_ERROR(bad value ${enableval} for --enable-exodus)])],
                         )
  ...
  AS_IF([test "x$enableexoduslongnames" = "xyes"],
        [
